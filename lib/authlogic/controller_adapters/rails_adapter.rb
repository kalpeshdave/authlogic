      ...
      module RailsImplementation
        def self.included(klass) # :nodoc:
          if defined?(::ApplicationController)
            raise AuthlogicLoadedTooLateError.new("Authlogic is trying to prepend a before_action in ActionController::Base to active itself" +
              ", the problem is that ApplicationController has already been loaded meaning the before_action won't get copied into your" +
